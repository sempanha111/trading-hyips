                ...
                <div class="list Super VIP">
                    ...
                    <div class="program Super VIP ">
                        ...
                        <div class="main clearfix">
                            ...
                            <div class="col23">
                                <div class="col2">
                                    ...
                                    <div class="lastpayout">Last Payout: <b>{{ $detail->program->status === 'Paying' ? \Carbon\Carbon::now()->format('M jS, Y') : \Carbon\Carbon::parse($detail->program->updated_at)->format('M jS, Y')}}</b></div>
                                    @php
                        ...
                        <div class="planmenu">
                            ...
                            <a href="../bookmarks/action/add/lid/1424/index.html">Bookmark</a>
