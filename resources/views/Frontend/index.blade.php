...
<div class="global_wrap">
        ...
        <div class="wrap">
            ...
            <div class="content clearfix">
                ...
                <div class="list Super VIP">
                    ...
                    <div class="program Super VIP ">
                        <div class="title clearfix">
                            ...
                            <div class="status {{$program->status === 'Paying' ? 'status1' : 'status4'}}">{{$program->status}}</div>
                        </div>
                ...
                <div class="list Exclusive">
                    ...
                    @endforeach
                    @else
                    <p>No Exclusive programs found.</p>
                    @endif
    ...
    <a href="http://127.0.0.1:8000/detail/15"><img src="http://127.0.0.1:8000/image/lid/17279275050.png" border="0"></a>
    @endsection
