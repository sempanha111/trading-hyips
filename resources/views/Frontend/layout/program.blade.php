...
<div class="program Premium ">
    <div class="title clearfix">
        <div class="title1">&nbsp;</div>
        <div class="title2"><a class="name" href="{{ $detail->link }}" target=_blank>{{$program->name}}</a></div>

        <div class="status {{$program->status === 'Paying' ? 'status1' : 'status៤'}}">{{$program->status}}</div>
    </div>

    <div class="main clearfix">
        <div class="col1 clearfix">
            <a href="{{ $detail->link}}" target=_blank><img
                    src="{{ asset('assets_backend/img/program/'.$detail->image) }}" alt="Bitcashdepositscreenshot"></a>
        </div>
        <div class="col23">
            <div class="col2">
                ...
                <div class="lastpayout">Last Payout: <b>{{ $detail->program->status === 'Paying' ?
                        ...
                        \Carbon\Carbon::parse($detail->program->updated_at)->format('M jS, Y')}}</b></div>
                    @php
        ...
        <div class="col4 clearfix">
            <div class="ourrating">
                ...
                <div class="emptystars">
                    <div class="fullstars" style="width: {{$detail->our_rate}}%" bis_skin_checked="1">
                    </div>
                </div>
            </div>
            <div class="usrrating">
                ...
                $threeRatings = $program->ratings->where('rate', 3)->count();
                ...
                $threeRatePercentage = ($threeRatings / $totalRatings) * 100;
                $twoRatePercentage = ($twoRatings / $totalRatings) * 100;
                $oneRatePercentage = ($oneRatings / $totalRatings) * 100;
                $zeroRatePercentage = ($zeroRatings / $totalRatings) * 100;
                ...
                <div class="emptystars">
                    ...
                    <div class="fullstars" style="width: {{ number_format($percentage, 2)  }}%"></div>
                </div>
            </div>
            <div class="votes_summary">
                <div class="summary mood3">
                    <div class="mood"></div>
                    <div class="rate">{{$threeRatings}} </div>
                </div>
    ...
    <div class="pay_options">
        ...
        <div class="paysystems">
            ...
            <img src="{{ asset('assets/images/PerfectMoney.gif') }}" alt="PerfectMoney" title="PerfectMoney">
            @endif
            ...
            <img src="{{ asset('assets/images/Bitcoin%20Cash.gif') }}" alt="Bitcoin Cash" title="Bitcoin Cash">
            @endif
            ...
            <img src="{{ asset('assets/images/Solidtrustpay.gif') }}" alt="Solidtrustpay" title="Solidtrustpay">
            @endif
...
@else
<p>No Super Vip programs found.</p>
@endif
